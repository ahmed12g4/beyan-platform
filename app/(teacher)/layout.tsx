...
export default function TeacherLayout({
    ...
    const mainNavItems = [
        { id: 'panelim', label: 'Panelim', href: '/teacher' },
        { id: 'derslerim', label: 'Derslerim', href: '/teacher/sessions' },
        { id: 'takvim', label: 'Ders Programı', href: '/teacher/schedule' },
    ]

    const managementItems = [
        { id: 'kurslarim', label: 'Kurs İçerikleri', href: '/teacher/courses' },
        { id: 'gruplarim', label: 'Gruplarım', href: '/teacher/groups' },
        { id: 'sinavlar', label: 'Sınavlar', href: '/teacher/quizzes' },
    ]
    ...
    return (
        <div style={{ fontFamily: 'var(--font-jakarta)' }} className="min-h-screen flex flex-col font-sans bg-white dark:bg-slate-900">
            {/* Top Navigation Bar */}
            <nav className="bg-brand-primary border-b border-brand-primary-dark sticky top-0 z-50 shadow-lg">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        {/* Left: Logo */}
                        <Link href="/teacher" className="flex items-center gap-3 flex-shrink-0">
                        ...
                        <div className="hidden lg:flex items-center gap-1">
                            ...
                            <div className="relative h-full flex items-center" data-management-dropdown>
                                <button
                                    ...
                                    className={`px-4 py-2 text-sm font-medium transition-all flex items-center gap-2 ${managementItems.some(i => pathname === i.href) || managementOpen
                                        ? 'text-white'
                                        : 'text-white hover:text-brand-accent'
                                        }`}
                                >
                            ...
                            <Link
                                ...
                                className={`px-4 py-2 text-sm font-medium transition-all relative ${pathname === '/teacher/settings'
                                    ? 'text-white'
                                    : 'text-white hover:text-brand-accent'
                                    }`}
                            >
                            ...
                            <div className="relative" data-account-dropdown>
                                ...
                                >
                                    <Avatar
                                        ...
                                        name={user.profile?.full_name || user.user?.email || 'Öğretmen'}
                                        size={40}
                    ...
                    mobileMenuOpen && (
                        <div data-mobile-menu className="lg:hidden border-t border-brand-primary-dark bg-brand-primary">
                            <div className="px-4 py-3 space-y-1">
                                {[...mainNavItems, ...managementItems].map((item: any) => {
                                    const isActive = pathname === item.href
                                    return (
                                        <Link
                                            key={item.id}
                                ...
                                <Link
                                    href="/teacher/settings"
                                    onClick={() => setMobileMenuOpen(false)}
                                    className={`block px-4 py-2.5 rounded-lg text-sm font-medium transition-all ${pathname === '/teacher/settings'
                                        ? 'text-brand-primary bg-brand-accent'
                                        : 'text-white hover:text-brand-accent hover:bg-brand-primary-dark'
                                        }`}
                                >

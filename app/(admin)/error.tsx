        ...
        <div className="min-h-[60vh] flex items-center justify-center px-4">
            <div className="bg-white rounded-lg border border-gray-100 shadow-sm p-10 max-w-md w-full text-center">
                ...
                <p className="text-gray-400 text-sm mb-6 leading-relaxed">
                    Panel yüklenirken beklenmedik bir sorun meydana geldi. Lütfen tekrar deneyin.
                </p>
                ...
                <div className="flex gap-3 justify-center">
                    ...
                    <a
                        href="/admin"
                        className="px-6 py-3 bg-gray-100 text-gray-700 rounded-lg font-bold text-sm hover:bg-gray-200 transition-colors"
                    >
                        Ana Panele Dön
                    </a>
                </div>
